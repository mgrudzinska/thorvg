...
void tvgDrawCmds(tvg::Canvas* canvas)
{
    ...
    shape1->appendArc(150, 150, 80, 45, 135, true);
    shape1->stroke(255, 255, 255, 255);
    shape1->stroke(2);
    if (canvas->push(move(shape1)) != tvg::Result::Success) return;

    auto shape2 = tvg::Shape::gen();
    shape2->appendArc(400, 150, 80, -45, -135, true);
    shape2->stroke(255, 255, 255, 255);
    shape2->stroke(2);
    if (canvas->push(move(shape2)) != tvg::Result::Success) return;

    auto shape3 = tvg::Shape::gen();
    shape3->appendArc(150, 400, 80, -30, 240, true);
    shape3->stroke(255, 255, 255, 255);
    shape3->stroke(2);
    if (canvas->push(move(shape3)) != tvg::Result::Success) return;

    auto shape4 = tvg::Shape::gen();
    shape4->appendArc(400, 400, 80, 30, -240, true);

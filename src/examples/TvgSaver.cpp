...
void tvgDrawCmds(tvg::Canvas* canvas)
{
    ...
    shape1->fill(91, 192, 93, 194);
/*
    shape1->stroke(5);
    shape1->stroke(255,0,100,200);
...
*/
    ...
    mask3->appendCircle(600, 500, 100, 100);
    mask3->fill(255, 0, 0, 255);
    image->composite(move(mask3), tvg::CompositeMethod::ClipPath);
    ...
    mask2->appendCircle(550, 150, 12, 12);
...
//    scene->push(move(image));
    ...
    // SAVING
    auto dup = unique_ptr<tvg::Scene>(static_cast<tvg::Scene*>(scene->duplicate()));
    tvg::Saver::save(move(dup), "tvg_file.tvg");
